...
(
id_staff INT (4) PRIMARY KEY AUTO_INCREMENT,
id_card CHAR(20) UNIQUE,
...
(
id_department INT(4) PRIMARY KEY AUTO_INCREMENT,
name CHAR(20) UNIQUE ,
...
(
    id_student int(4) PRIMARY KEY AUTO_INCREMENT,
    name char(10),
    stusex char(2),
...
(
    id_parent int(4) primary key AUTO_INCREMENT,
    name char(10),
    phone char(11) UNIQUE,
    e_mail char(20) UNIQUE,
...
(
  id_parttime INT (4) PRIMARY KEY AUTO_INCREMENT,
  name CHAR (20),
  phone CHAR (11) UNIQUE,
  e_mail CHAR (20) UNIQUE ,
...
(
   id_notice int(4) primary key AUTO_INCREMENT,
   title varchar(50),
   content mediumtext,
   cover VARCHAR (50),
   image VARCHAR (50),
...
(
    id_link int(4) primary key AUTO_INCREMENT,
...
(
    id_file int(4) primary key AUTO_INCREMENT,
    name varchar(50),
    src varchar(50),
    dload_time int(4)
)";
...
(
    id_unused INT (4) PRIMARY KEY AUTO_INCREMENT,
    id_owner INT(4),
    type CHAR (2),
    item CHAR (20),
    img VARCHAR (50),
...
(
    id_owner INT (4) PRIMARY KEY AUTO_INCREMENT,
    name CHAR (2),
    phone CHAR(11) UNIQUE,
    id_type CHAR(4),
...
$lose="create table lost(
  id_lost INT (4) PRIMARY KEY AUTO_INCREMENT,
  type CHAR (4),
  item CHAR (20),
  img VARCHAR (50),
  description VARCHAR (400),
